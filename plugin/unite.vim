...
call unite#custom#profile('file,file_rec,file_rec/async,buffer,file_mru', 'context', { 'start_insert': 1, 'resume': 1 })
call unite#custom#source('grep', 'context', { 'start_insert': 0, 'focus': 0, 'resume': 0 })
